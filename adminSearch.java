...
public class adminSearch extends JFrame implements ActionListener {
    ...
    adminSearch() {
        // Your existing constructor code remains the same until the end
        setSize(1000, 800);
        setLayout(null);
        ...
        // Remove the text area since we're using the table instead
        // txaDisplayEventFound is no longer needed
