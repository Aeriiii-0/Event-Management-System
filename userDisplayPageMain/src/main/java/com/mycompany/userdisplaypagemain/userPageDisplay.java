...
public class userPageDisplay extends JFrame implements ActionListener{
       JButton btnBirthday,btnWedding, btnChristening;
       JLabel lblBirthday, lblWedding,lblChristening, lblHeader, lblButton;
       JPanel pnlChoose;
   ...
   userPageDisplay(){
        ...
        ImageIcon wedImage = new ImageIcon("Wedding2.jpg");
        ...
        ImageIcon binyagImage = new ImageIcon("binyag2.jpg");
        ...
        lblButton = new JLabel("SELECT AN EVENT");
        lblButton.setBounds(400, 550, 220, 60); 
        lblButton.setBackground(new Color(190, 140, 229));
        lblButton.setFont(new Font("Serif",Font.BOLD,20));
        add(lblButton);
