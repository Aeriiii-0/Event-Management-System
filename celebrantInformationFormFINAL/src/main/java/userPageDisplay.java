...
public class userPageDisplay extends JFrame implements ActionListener{
   ...
   userPageDisplay(){
       //Layout of the Frame
        ...
        //birthday components. (bounds > image > panel) This button allows the user to proceed to the celebrant information form
       ...
       //This button allows the user to proceed to the celebrant information form
       ...
       public void actionPerformed(ActionEvent e){
             ...
             this.dispose();//WHEN THE USER CLICK THE BIRTHDAY BUTTON THE FRAME WILL DIRECTLY GO TO THE CELEBRANT INFORMATION FORM
             new celebrantInformationForm();
             dispose();
        } else if (e.getSource() == btnWedding) {
            this.dispose();//WHEN THE USER CLICK THE WEDDING BUTTON THE FRAME WILL DIRECTLY GO TO THE CELEBRANT INFORMATION FORM
            new celebrantInformationForm();
            dispose();
        } else if (e.getSource() == btnChristening) {
            this.dispose();//WHEN THE USER CLICK THE CHRISTENING BUTTON THE FRAME WILL DIRECTLY GO TO THE CELEBRANT INFORMATION FORM
            new celebrantInformationForm();
        } else {
